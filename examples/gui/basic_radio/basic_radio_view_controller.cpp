...
BasicRadioViewController::BasicRadioViewController(BasicRadio& _radio, const int _max_textures) 
...
void BasicRadioViewController::ClearSearch(void) {
    services_filter.Clear();
}

Texture* BasicRadioViewController::GetTexture(subchannel_id_t subchannel_id, mot_transport_id_t transport_id) {
...
Texture* BasicRadioViewController::AddTexture(
...
SelectedSlideshowView BasicRadioViewController::GetSelectedSlideshow() {
    return selected_slideshow;
}
void BasicRadioViewController::SetSelectedSlideshow(SelectedSlideshowView _selected_slideshow) {
